...
import com.citypass.utils.JSONTools;
...
public class BaseAction extends ActionSupport implements ServletContextAware,
	...
	protected void print(Object object, String... params) {
		out.print(JSONTools.toJsonString(object, params));
	}
}
